  ...
  return (
    <html lang="ru" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        ...
        />
        {/* Яндекс Метрика — добавьте код после получения счётчика */}
        {/* <script dangerouslySetInnerHTML={{ __html: `(function(m,e,t,r,i,k,a){...})(window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "XXXXXXXX");` }} /> */}
      </head>
